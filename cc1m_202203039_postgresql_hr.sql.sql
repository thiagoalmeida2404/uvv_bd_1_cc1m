...
CREATE USER thiagoo WITH PASSWORD '202203039';
ALTER USER thiagoo WITH SUPERUSER;
CREATE DATABASE uvv
    WITH 
    OWNER = thiagoo
    TEMPLATE = template0
...
GRANT ALL ON DATABASE uvv TO thiagoo;
ALTER DEFAULT PRIVILEGES
GRANT ALL ON TABLES TO thiagoo;
...
ALTER USER thiagoo SET SEARCH_PATH TO hr, "\$user", public;
